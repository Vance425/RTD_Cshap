...
namespace RTDWebAPI.Interface
{
    public interface IFunctionService
    {
        ...
        bool BuildTransferCommands(DBTool _dbTool, IConfiguration configuration, ILogger _logger, bool DebugMode, EventQueue _oEventQ, Dictionary<string, string> _threadControll, List<string> _lstEquipment, out List<string> _arrayOfCmds, ConcurrentQueue<EventQueue> _eventQueue);
        bool CreateTransferCommandByPortModel(DBTool _dbTool, IConfiguration configuration, ILogger _logger, bool DebugMode, string _Equip, string _portModel, EventQueue _oEventQ, out List<string> _arrayOfCmds, ConcurrentQueue<EventQueue> _eventQueue);
        ...
        string GetCarrierByPortId(DBTool _dbTool, string _portId);
        DataTable ConvertCSVtoDataTable(string strFilePath);
        DataTable GetAvailableCarrierByLocate(DBTool _dbTool, string _carrierType, string _locate, bool _isFull, string _workgroup);
        DataTable GetAvailableCarrierByLocate(DBTool _dbTool, IConfiguration _configuration, string _carrierType, string _lotID, string _locate, bool _isFull, string _RTDEnv, string _workgroup);
        DataTable GetAvailableCarrierForFVC(DBTool _dbTool, IConfiguration _configuration, string _carrierType, List<string> _agvs, bool _isFull, string _RTDEnv);
        bool SyncQtimeforOnlineLot(DBTool _dbTool, IConfiguration _configuration);
        DataTable GetAvailableCarrier(DBTool _dbTool, string _carrierType, bool _isFull, string _RTDEnv);
        bool CheckPORCAndReset(DBTool _dbTool);
        APIResult SentBatchEvent(DBTool _dbTool, IConfiguration _configuration, ILogger _logger, bool isManual, string _equip);
        bool AutoTriggerFurneceBatchin(DBTool _dbTool, IConfiguration _configuration, ILogger _logger);
